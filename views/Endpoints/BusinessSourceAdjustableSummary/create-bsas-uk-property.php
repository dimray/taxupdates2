...
<form action="/business-source-adjustable-summary/process" method="POST" class="generic-form"
    ...
    <div class="form-input">
        <label for="reversePremiums">Reverse Premiums</label>
        <input type="number" min="-99999999999.99" max="99999999999.99" step="0.01" name="reversePremiums"
            id="reversePremiums" value="<?= $income['reversePremiums'] ?? '' ?>">
    </div>
