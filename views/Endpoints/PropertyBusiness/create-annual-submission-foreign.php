<?php if (!empty($country_codes)): ?>
    ...
    <p>Enter adjustment and allowance claims for each country in which you have property. Adjustments should only be
        ...
        Updates.</p>
    <p>If you need to enter adjustments for more than one country, save your data for one country and you
        will then be given the option to add other countries.</p>

<?php else: ?>

    <p>Enter adjustment and allowance claims for each property individually. Adjustments should only be
        submitted for properties which have been included in submitted Cumulative
        Updates.</p>
    <p>If you need to enter adjustments for more than one property, save your data for one property and you
        will then be given the option to add others.</p>
    ...
    <div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="privateUseAdjustment"
                name="privateUseAdjustment" value="<?= $input_data['adjustments']['privateUseAdjustment'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="balancingCharge" name="balancingCharge"
                value="<?= $input_data['adjustments']['balancingCharge'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="annualInvestmentAllowance"
                ...
                value="<?= $input_data['allowances']['annualInvestmentAllowance'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="costOfReplacingDomesticItems"
                ...
                value="<?= $input_data['allowances']['costOfReplacingDomesticItems'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="otherCapitalAllowance"
                name="otherCapitalAllowance" value="<?= $input_data['allowances']['otherCapitalAllowance'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="zeroEmissionsCarAllowance"
                ...
                value="<?= $input_data['allowances']['zeroEmissionsCarAllowance'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="1000" step="0.01" id="propertyIncomeAllowance"
                ...
                value="<?= $input_data['allowances']['propertyIncomeAllowance'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="number" min="0" max="99999999999.99" step="0.01" id="sba_amount" name="sba_amount"
                value="<?= $input_data['sba']['sba_amount'] ?? '' ?>">
        </div>
        ...
        <div class="form-input">
            ...
            <input type="date" id="sba_qualifyingDate" name="sba_qualifyingDate"
                value="<?= $input_data['sba']['sba_qualifyingDate'] ?? '' ?>">
        </div>
