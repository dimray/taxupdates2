...
<div class="spacer">
    ...
    <form action="/employments-income/create-amend-employment-financial-details" method="POST">
        ...
        <button class="button" type="submit">Edit Financial Details</button>
    </form>

    <?php if ($employment_type === "hmrc"): ?>

        <form action="/employments-income/confirm-delete-employment-financial-details" method="POST">
            <button class="button" type="submit">Delete Edits To Financial Details</button>
        </form>

        <form action="/employments-income/confirm-ignore-employment">
            <button class="button" type="submit">Ignore This Employment</button>
        </form>

        <form action="/employments-income/confirm-unignore-employment">
            <button class="button" type="submit">Unignore This Employment</button>
        </form>

    <?php elseif ($employment_type === "custom"): ?>

        <form action="/employments-income/confirm-delete-employment-financial-details" method="POST">
            <button class="button" type="submit">Delete Financial Details</button>
        </form>
