        ...
        <div id="seafarers-container">
            ...
            <?php foreach (($seafarers ?? []) as $ship): ?>
                ...
                <div class="seafarers-group field-container" data-group="seafarers">
                    ...
                    <div class="nested-input">
                        <label>Name Of Ship
                            <input type="text" data-name="nameOfShip" maxlength="90"
                    ...
                    <div class="nested-input">
                        ...
                        <input type="date" data-name="fromDate" value="<?= esc($ship['fromDate'] ?? '') ?>" required>
                    </div>

                    <div class="nested-input">
                        <label>To Date</label>
                        <input type="date" data-name="toDate" value="<?= esc($ship['toDate'] ?? '') ?>" required>
                    </div>
