            ...
            <tbody>
                <?php foreach ($claims as $claim): ?>
                    <tr>
                        ...
                        <?php if ($sideways_claim_count > 1 && $claim['typeOfClaim'] === "carry-sideways"): ?>
                        ...
                        <td>
                            <form class="hmrc-connection" action="/individual-losses/delete-loss-claim" method="GET">
...
<?php if (!empty($business_details)): ?>
    ...
    <p>Showing loss claims for this business only.</p>

    <p><a class="hmrc-connection" href="/individual-losses/list-loss-claims?all_businesses=true">View Loss Claims For All
            Businesses</a></p>
...
<?php if ($sideways_claim_count > 1) : ?>
    ...
    <form action="/individual-losses/edit-loss-claims-sequence" method="POST">
        ...
        <button class="link" type="submit">Change
            The Order Of Loss Claims</button>
...
<?php else: ?>
    ...
    <p><a href="/business-details/list-all-businesses?year_end=true">Add A Claim</a></p>
