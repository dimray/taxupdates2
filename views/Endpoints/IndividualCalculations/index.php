...
<div id="countdown-msg">
    <p>HMRC is preparing your latest tax calculation</p>
    <p>Please wait <span id="countdown" data-start="7">7</span>
        seconds</p>
...
<form class="hmrc-connection" action="/individual-calculations/retrieve-calculation">
    ...
    <button class="button hidden" id="countdown-button" disabled=false>View Your Calculation</button>
