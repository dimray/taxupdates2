    ...
    <table class="clients-table desktop-view">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?= $client['authorisation'] ? esc($client['authorisation']) : "unauthorised" ?>
                </td>
                ...
                <td>
                    <form class="hmrc-connection" action="/clients/index" method="POST">
                        ...
                        <button class="button select-button" type="submit">Select</button>
                    </form>
                ...
                <td>
                    <form action="/clients/index" method="POST">
                        ...
                        <button class="link light" type="submit">Authorisation</button>
                    </form>
                </td>
    ...
    <div class="mobile-view">
        ...
        <div class="card">
            ...
            <div class="data-row">
                ...
                <div class="value">
                    <?= $client['authorisation'] ? esc($client['authorisation']) : "unauthorised" ?></div>
            </div>
