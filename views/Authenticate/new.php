...
<?php if ($user_role === "agent" && $client_name): ?>
    ...
    <p>If you are already authorised to act for <?= $client_name ?>, you have reached this page because HMRC are
        requiring you to authorise or re-authorise this site before you can view your client's data here.</p>
    ...
    <p>If you are unsure whether you are authorised to act for <?= $client_name ?>, you can check the client relationship <a
            href="/agent-authorisation/request-status-of-relationship">here</a>.</p>
